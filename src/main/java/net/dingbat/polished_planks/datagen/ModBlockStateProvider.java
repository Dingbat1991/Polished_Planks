...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_ACACIA_BUTTON.get()), blockTexture(ModBlocks.POLISHED_ACACIA_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_ACACIA_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_ACACIA_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_ACACIA_FENCE.get()), blockTexture(ModBlocks.POLISHED_ACACIA_PLANKS.get()));
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_BAMBOO_BUTTON.get()), blockTexture(ModBlocks.POLISHED_BAMBOO_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_BAMBOO_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_BAMBOO_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_BAMBOO_FENCE.get()), blockTexture(ModBlocks.POLISHED_BAMBOO_PLANKS.get()));
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_BIRCH_BUTTON.get()), blockTexture(ModBlocks.POLISHED_BIRCH_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_BIRCH_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_BIRCH_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_BIRCH_FENCE.get()), blockTexture(ModBlocks.POLISHED_BIRCH_PLANKS.get()));
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_CHERRY_BUTTON.get()), blockTexture(ModBlocks.POLISHED_CHERRY_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_CHERRY_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_CHERRY_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_CHERRY_FENCE.get()), blockTexture(ModBlocks.POLISHED_CHERRY_PLANKS.get()));
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_CRIMSON_BUTTON.get()), blockTexture(ModBlocks.POLISHED_CRIMSON_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_CRIMSON_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_CRIMSON_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_CRIMSON_FENCE.get()), blockTexture(ModBlocks.POLISHED_CRIMSON_PLANKS.get()));
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_DARK_OAK_BUTTON.get()), blockTexture(ModBlocks.POLISHED_DARK_OAK_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_DARK_OAK_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_DARK_OAK_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_DARK_OAK_FENCE.get()), blockTexture(ModBlocks.POLISHED_DARK_OAK_PLANKS.get()));
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_JUNGLE_BUTTON.get()), blockTexture(ModBlocks.POLISHED_JUNGLE_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_JUNGLE_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_JUNGLE_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_JUNGLE_FENCE.get()), blockTexture(ModBlocks.POLISHED_JUNGLE_PLANKS.get()));
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_MANGROVE_BUTTON.get()), blockTexture(ModBlocks.POLISHED_MANGROVE_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_MANGROVE_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_MANGROVE_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_MANGROVE_FENCE.get()), blockTexture(ModBlocks.POLISHED_MANGROVE_PLANKS.get()));
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_OAK_BUTTON.get()), blockTexture(ModBlocks.POLISHED_OAK_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_OAK_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_OAK_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_OAK_FENCE.get()), blockTexture(ModBlocks.POLISHED_OAK_PLANKS.get()));
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_SPRUCE_BUTTON.get()), blockTexture(ModBlocks.POLISHED_SPRUCE_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_SPRUCE_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_SPRUCE_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_SPRUCE_FENCE.get()), blockTexture(ModBlocks.POLISHED_SPRUCE_PLANKS.get()));
        ...
        buttonBlock(((ButtonBlock) ModBlocks.POLISHED_WARPED_BUTTON.get()), blockTexture(ModBlocks.POLISHED_WARPED_PLANKS.get()));
        pressurePlateBlock(((PressurePlateBlock) ModBlocks.POLISHED_WARPED_PRESSURE_PLATE.get()),
                blockTexture(ModBlocks.POLISHED_WARPED_PLANKS.get()));

        fenceBlock(((FenceBlock) ModBlocks.POLISHED_WARPED_FENCE.get()), blockTexture(ModBlocks.POLISHED_WARPED_PLANKS.get()));
        ...
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_ACACIA_DOOR.get()),
                modLoc("block/polished_acacia_door_bottom"), modLoc("block/polished_acacia_door_top"), "cutout");
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_BAMBOO_DOOR.get()),
                modLoc("block/polished_bamboo_door_bottom"), modLoc("block/polished_bamboo_door_top"), "cutout");
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_BIRCH_DOOR.get()),
                modLoc("block/polished_birch_door_bottom"), modLoc("block/polished_birch_door_top"), "cutout");
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_CHERRY_DOOR.get()),
                modLoc("block/polished_cherry_door_bottom"), modLoc("block/polished_cherry_door_top"), "cutout");
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_CRIMSON_DOOR.get()),
                modLoc("block/polished_crimson_door_bottom"), modLoc("block/polished_crimson_door_top"), "cutout");
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_DARK_OAK_DOOR.get()),
                modLoc("block/polished_dark_oak_door_bottom"), modLoc("block/polished_dark_oak_door_top"), "cutout");
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_JUNGLE_DOOR.get()),
                modLoc("block/polished_jungle_door_bottom"), modLoc("block/polished_jungle_door_top"), "cutout");
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_MANGROVE_DOOR.get()),
                modLoc("block/polished_mangrove_door_bottom"), modLoc("block/polished_mangrove_door_top"), "cutout");
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_OAK_DOOR.get()),
                modLoc("block/polished_oak_door_bottom"), modLoc("block/polished_oak_door_top"), "cutout");
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_SPRUCE_DOOR.get()),
                modLoc("block/polished_spruce_door_bottom"), modLoc("block/polished_spruce_door_top"), "cutout");
        doorBlockWithRenderType(((DoorBlock) ModBlocks.POLISHED_WARPED_DOOR.get()),
                modLoc("block/polished_warped_door_bottom"), modLoc("block/polished_warped_door_top"), "cutout");
    }
